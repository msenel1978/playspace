...
static int
init_arry(int delta_arry[], int len){
	int i = 0;
...
static int
cumulative_arry(int delta_arry[], int len){
	int i;
...
static int
print_arry_content(int arry[], int len) {
	int i = 0;
...
static int
find_max_birth_yr(person_t population[]) {
...
static int
find_min_birth_yr(person_t population[]) {
...
static int
find_max_yr(int cum_arry[], int init_yr, int len) {
	int i = 0, max_yr = 0;
...
static int
find_max_pop_yr(person_t population[]) {
